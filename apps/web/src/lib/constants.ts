...
export const CURRENCIES = [{ code: 'BDT', symbol: '৳', name: 'Bangladeshi Taka' }] as const;
...
export const PAYMENT_PARTNERS = [
  {
    name: 'bKash',
    logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 30'%3E%3Ctext x='10' y='20' fill='%23E2136E' font-size='20' font-weight='bold'%3EbKash%3C/text%3E%3C/svg%3E",
  },
  {
    name: 'Nagad',
    logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 30'%3E%3Ctext x='10' y='20' fill='%23EA1747' font-size='20' font-weight='bold'%3ENagad%3C/text%3E%3C/svg%3E",
  },
  {
    name: 'Visa',
    logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 30'%3E%3Ctext x='10' y='20' fill='%231434CB' font-size='20' font-weight='bold'%3EVISA%3C/text%3E%3C/svg%3E",
  },
  {
    name: 'Mastercard',
    logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 30'%3E%3Ctext x='5' y='20' fill='%23EB001B' font-size='18' font-weight='bold'%3EMastercard%3C/text%3E%3C/svg%3E",
  },
] as const;
