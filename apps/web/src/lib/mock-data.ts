...
export const mockCategories: Category[] = [
  { id: "hotels", name: "Hotels & Resorts", icon: "🏨", count: 450, description: "Comfortable stays nationwide" },
  { id: "tours", name: "Tour Packages", icon: "🗺️", count: 320, description: "Curated travel experiences" },
  { id: "experiences", name: "Experiences", icon: "🎭", count: 180, description: "Unique activities & adventures" },
  { id: "transport", name: "Transportation", icon: "🚗", count: 95, description: "Reliable travel solutions" },
  { id: "adventure", name: "Adventure Sports", icon: "🏔️", count: 67, description: "Thrilling outdoor activities" },
  { id: "cultural", name: "Cultural Tours", icon: "🏛️", count: 123, description: "Heritage & tradition" },
];
...
export const mockFAQs: FAQ[] = [
  {
    ...
    answer: "Your payment is securely held in our escrow account until the service is delivered and verified. The seller receives payment only after you confirm service completion or after automatic verification. This protects both buyers and sellers.",
    category: "Escrow",
  },
  {
    id: "faq-2",
    question: "What is group booking and how does it save money?",
    answer: "Group booking allows multiple travelers to book together and get tiered discounts. As more members join, everyone's price decreases automatically. You can save up to 40% compared to individual bookings. Plus, earlier members get automatic refunds when the price tier upgrades!",
    category: "Groups",
  },
  {
    id: "faq-3",
    question: "How does price lock protection work?",
    answer: "When you enable price lock at checkout, we monitor the booking price continuously. If the price drops before your travel date (due to promotions, group tier upgrades, or seller discounts), we automatically refund you the difference. You're protected from price increases too!",
    category: "Booking",
  },
  {
    id: "faq-4",
    question: "Can I split payment with my friends for a booking?",
    answer: "Yes! For group bookings, the organizer can enable split payment. Each member gets a payment link and can pay their share separately. The booking is confirmed only after all payments are received by the deadline. Very convenient for group trips!",
    category: "Payment",
  },
  {
    id: "faq-5",
    question: "What is your cancellation policy?",
    answer: "Cancellation policies vary by listing (Flexible, Moderate, Strict, or Non-refundable). The policy is clearly displayed before booking. Most listings offer full or partial refunds if cancelled with sufficient notice. Refunds are processed within 5-7 business days.",
    category: "Refunds",
  },
  {
    id: "faq-6",
    question: "How do I know if a seller is trustworthy?",
    answer: "We verify all sellers by checking their business license, NID, and relevant permits. Verified sellers get a badge on their profile. You can also check ratings, reviews, and response time before booking. All payments go through escrow for your protection.",
    category: "General",
  },
  {
    id: "faq-7",
    question: "What happens if the service is not provided as described?",
    answer: "You can raise a dispute within 7 days of the service date. Upload evidence and explain the issue. Our admin team reviews both sides and makes a fair decision within 72 hours. Refunds (full or partial) are issued based on the resolution.",
    category: "Escrow",
  },
  {
    id: "faq-8",
    question: "How long does it take for sellers to receive payment?",
    answer: "Sellers receive payment after service delivery is verified. They upload proof of service completion (photos, attendance, etc.), which is reviewed within 24 hours. Once approved, funds are released to their bank account within 3-5 business days.",
    category: "Payment",
  },
];
...
export const mockBlogPosts: BlogPost[] = [
  {
    ...
    excerpt: "Discover lesser-known destinations that offer breathtaking beauty and authentic cultural experiences away from the usual tourist crowds.",
  ...
  },
  {
    ...
    excerpt: "Learn how to organize perfect group trips, leverage group discounts, and use split payment features to travel more for less.",
  ...
  },
  {
    ...
    excerpt: "Understanding how secure payment systems protect your money and ensure quality service delivery in the travel industry.",
...
export const mockPartners: Partner[] = [
  { id: "partner-1", name: "Bangladesh Tourism Board", logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 50'%3E%3Crect width='100' height='50' fill='%23006747'/%3E%3Ctext x='50' y='30' text-anchor='middle' fill='white' font-size='12' font-weight='bold'%3EBTB%3C/text%3E%3C/svg%3E" },
  { id: "partner-2", name: "Hotel Association", logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 50'%3E%3Crect width='100' height='50' fill='%23FF6B6B'/%3E%3Ctext x='50' y='30' text-anchor='middle' fill='white' font-size='10' font-weight='bold'%3EHotel Assoc%3C/text%3E%3C/svg%3E" },
  { id: "partner-3", name: "Tour Operators Guild", logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 50'%3E%3Crect width='100' height='50' fill='%234ECDC4'/%3E%3Ctext x='50' y='30' text-anchor='middle' fill='white' font-size='11' font-weight='bold'%3ETOG%3C/text%3E%3C/svg%3E" },
  { id: "partner-4", name: "Travel Insurance BD", logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 50'%3E%3Crect width='100' height='50' fill='%23FFE66D'/%3E%3Ctext x='50' y='30' text-anchor='middle' fill='%23333' font-size='10' font-weight='bold'%3EInsurance%3C/text%3E%3C/svg%3E" },
  { id: "partner-5", name: "Eco Tourism Alliance", logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 50'%3E%3Crect width='100' height='50' fill='%2395E1D3'/%3E%3Ctext x='50' y='30' text-anchor='middle' fill='white' font-size='11' font-weight='bold'%3EEco Tour%3C/text%3E%3C/svg%3E" },
  { id: "partner-6", name: "Bangladesh Bank", logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 50'%3E%3Crect width='100' height='50' fill='%23006747'/%3E%3Ctext x='50' y='30' text-anchor='middle' fill='white' font-size='10' font-weight='bold'%3EBD Bank%3C/text%3E%3C/svg%3E" },
];
