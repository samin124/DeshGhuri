import { db, seller, listing, LISTING_CATEGORIES, LISTING_STATUSES, CANCELLATION_POLICIES, PRICE_UNITS } from '@DeshGhuri/db';
  ...
  const hotels = [
    {
      ...
      description: 'Experience the longest natural sea beach in the world from our premium beachfront resort. All rooms feature ocean views, private balconies, and modern amenities. Perfect for families and couples.',
      location: { city: "Cox's Bazar", district: "Cox's Bazar", address: 'Marine Drive, Kolatoli Beach', landmark: 'Near Sugandha Point' },
      basePrice: '8500',
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d', storageKey: 'placeholder-1', isPrimary: true },
        { url: 'https://images.unsplash.com/photo-1566073771259-6a8506099945', storageKey: 'placeholder-2', isPrimary: false },
        { url: 'https://images.unsplash.com/photo-1582719508461-905c673771fd', storageKey: 'placeholder-3', isPrimary: false },
      ],
    ...
    },
    {
      ...
      description: 'Stay in the heart of Dhaka with modern comfort and traditional hospitality. Our boutique hotel offers personalized service, rooftop dining, and easy access to business districts.',
      location: { city: 'Dhaka', district: 'Dhaka', address: 'Gulshan-1, Road 25', landmark: 'Near Gulshan Lake Park' },
      basePrice: '6500',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 30,
      maxGuests: 3,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1564501049412-61c2a3083791', storageKey: 'placeholder-4', isPrimary: true },
        { url: 'https://images.unsplash.com/photo-1596394516093-501ba68a0ba6', storageKey: 'placeholder-5', isPrimary: false },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Escape to the tea gardens of Sylhet. Our eco-resort offers panoramic views of rolling hills, organic meals, and guided nature walks.',
      location: { city: 'Sylhet', district: 'Sylhet', address: 'Srimongal Tea Estate', landmark: 'Lawachara National Park' },
      basePrice: '4500',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 20,
      maxGuests: 4,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1586611292717-f8c4b7a6e9d1', storageKey: 'placeholder-6', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Modern business hotel in the port city. Close to Patenga Beach and commercial areas. Ideal for business travelers and tourists.',
      location: { city: 'Chittagong', district: 'Chittagong', address: 'Agrabad Commercial Area', landmark: 'Near GEC Circle' },
      basePrice: '5500',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 40,
      maxGuests: 3,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa', storageKey: 'placeholder-7', isPrimary: true },
        { url: 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb', storageKey: 'placeholder-8', isPrimary: false },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Witness both sunrise and sunset from the same beach! Our resort offers direct beach access, fresh seafood, and peaceful surroundings.',
      location: { city: 'Kuakata', district: 'Patuakhali', address: 'Kuakata Beach Road', landmark: 'Near Gangamati Reserved Forest' },
      basePrice: '4000',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 25,
      maxGuests: 4,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4', storageKey: 'placeholder-9', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Mountain retreat in Bandarban with stunning valley views. Perfect base for exploring Nilgiri, Boga Lake, and tribal villages.',
      location: { city: 'Bandarban', district: 'Bandarban', address: 'Chimbuk Road', landmark: 'Near Golden Temple' },
      basePrice: '3500',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 15,
      maxGuests: 3,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4', storageKey: 'placeholder-10', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Budget-friendly hotel in the Silk City. Explore mango orchards, Puthia Temple complex, and local silk markets.',
      location: { city: 'Rajshahi', district: 'Rajshahi', address: 'Shaheb Bazar', landmark: 'Near Padma Garden' },
      basePrice: '2500',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 20,
      maxGuests: 2,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1611892440504-42a792e24d32', storageKey: 'placeholder-11', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Colonial-era architecture meets modern comfort. Perfect for exploring Tajhat Palace and the northern region.',
      location: { city: 'Rangpur', district: 'Rangpur', address: 'Station Road', landmark: 'Near Carmichael College' },
      basePrice: '3000',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 18,
      maxGuests: 3,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5', storageKey: 'placeholder-12', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Experience royal hospitality near Kantaji Temple. Spacious rooms, traditional cuisine, and cultural programs.',
      location: { city: 'Dinajpur', district: 'Dinajpur', address: 'Pulhat Road', landmark: 'Near Kantaji Temple' },
      basePrice: '3200',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 22,
      maxGuests: 4,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1578683010236-d716f9a3f461', storageKey: 'placeholder-13', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Bangladesh\'s only coral island! Stay in beachfront cottages, snorkel in crystal-clear waters, and enjoy fresh coconuts.',
      location: { city: 'Saint Martin', district: "Cox's Bazar", address: 'West Beach', landmark: 'Chera Dwip' },
      basePrice: '5000',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 12,
      maxGuests: 3,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19', storageKey: 'placeholder-14', isPrimary: true },
        { url: 'https://images.unsplash.com/photo-1505142468610-359e7d316be0', storageKey: 'placeholder-15', isPrimary: false },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Immerse yourself in old Dhaka\'s charm. Walking distance to Lalbagh Fort, Ahsan Manzil, and Sadarghat River Port.',
      location: { city: 'Dhaka', district: 'Dhaka', address: 'Islampur Road', landmark: 'Near Lalbagh Fort' },
      basePrice: '4200',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 16,
      maxGuests: 2,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1584132967334-10e028bd69f7', storageKey: 'placeholder-16', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Your gateway to the Sundarbans. Comfortable accommodation with expert tour planning assistance.',
      location: { city: 'Khulna', district: 'Khulna', address: 'Khan Jahan Ali Road', landmark: 'Near Rupsha Bridge' },
      basePrice: '3800',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 28,
      maxGuests: 3,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1566073771259-6a8506099945', storageKey: 'placeholder-17', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Stay near the UNESCO World Heritage Site of Paharpur Buddhist Monastery. Ideal for history enthusiasts.',
      location: { city: 'Naogaon', district: 'Rajshahi', address: 'Paharpur', landmark: 'Somapura Mahavihara' },
      basePrice: '2800',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 10,
      maxGuests: 2,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1551918120-9739cb430c6d', storageKey: 'placeholder-18', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Experience the Venice of Bengal. Convenient access to floating markets, backwater cruises, and Durga Sagar.',
      location: { city: 'Barisal', district: 'Barisal', address: 'Sadar Road', landmark: 'Near Gournadi River' },
      basePrice: '3300',
      priceUnit: PRICE_UNITS.PER_NIGHT,
      capacity: 24,
      maxGuests: 3,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1582719508461-905c673771fd', storageKey: 'placeholder-19', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Southernmost tip of Bangladesh with pristine beaches. Currently under verification.',
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4', storageKey: 'placeholder-20', isPrimary: true },
      ],
    ...
    },
    {
      ...
      cancellationPolicy: CANCELLATION_POLICIES.FLEXIBLE,
      images: [
        { url: 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa', storageKey: 'placeholder-21', isPrimary: true },
      ],
...
async function createTourPackages(sellers: any[]) {
  ...
  const tours = [
    {
      ...
      description: 'Explore the world\'s largest mangrove forest and spot Royal Bengal Tigers, crocodiles, and exotic birds. Includes boat safari, guided tours, and traditional meals.',
      location: { city: 'Khulna', district: 'Khulna', address: 'Mongla Port departure', landmark: 'Sundarbans National Park' },
      basePrice: '12000',
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1604055195689-6e55a1c81a63', storageKey: 'tour-1', isPrimary: true },
        { url: 'https://images.unsplash.com/photo-1564760055775-d63b17a55c44', storageKey: 'tour-2', isPrimary: false },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Journey to the "Roof of Rangamati" and witness breathtaking mountain views, tribal culture, and stunning sunrises above the clouds.',
      location: { city: 'Rangamati', district: 'Rangamati', address: 'Sajek Valley', landmark: 'Konglak Para Viewpoint' },
      basePrice: '8500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 30,
      maxGuests: 30,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4', storageKey: 'tour-3', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Explore Bangladesh\'s only freshwater swamp forest by boat. Perfect during monsoon season when the forest is submerged.',
      location: { city: 'Sylhet', district: 'Sylhet', address: 'Gowainghat', landmark: 'Ratargul Swamp Forest' },
      basePrice: '3500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 25,
      maxGuests: 25,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1551244072-5d12893278ab', storageKey: 'tour-4', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Full-day guided walking tour of Old Dhaka. Visit 400-year-old monuments, bustling bazaars, and traditional food streets.',
      location: { city: 'Dhaka', district: 'Dhaka', address: 'Old Dhaka', landmark: 'Lalbagh Fort' },
      basePrice: '1500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 15,
      maxGuests: 15,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1609137144813-7d9921338f24', storageKey: 'tour-5', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Trek to the highest peak accessible by road in Bangladesh. Watch clouds pass beneath you at 2200 feet elevation.',
      location: { city: 'Bandarban', district: 'Bandarban', address: 'Thanchi Road', landmark: 'Nilgiri Tourist Spot' },
      basePrice: '6500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 20,
      maxGuests: 20,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b', storageKey: 'tour-6', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Visit the largest concentration of historic Hindu temples in Bangladesh. Architecture dating back to the 16th century.',
      location: { city: 'Rajshahi', district: 'Rajshahi', address: 'Puthia', landmark: 'Govinda Temple' },
      basePrice: '2500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 30,
      maxGuests: 30,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1548013146-72479768bada', storageKey: 'tour-7', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: '2-day trek to the mysterious Boga Lake at 1,246m elevation. Natural crater lake surrounded by mountains.',
      location: { city: 'Bandarban', district: 'Bandarban', address: 'Ruma Upazila', landmark: 'Boga Lake' },
      basePrice: '9500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 16,
      maxGuests: 16,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4', storageKey: 'tour-8', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Discover one of the earliest urban archaeological sites in Bangladesh. 3rd century BCE fortified city.',
      location: { city: 'Bogra', district: 'Rajshahi', address: 'Shibganj', landmark: 'Mahasthangarh Museum' },
      basePrice: '3000',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 25,
      maxGuests: 25,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1577717903315-1691ae25ab3f', storageKey: 'tour-9', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: '3-day journey through tribal villages. Meet the Chakma, Marma, and Tripura communities. Authentic cultural immersion.',
      location: { city: 'Rangamati', district: 'Chittagong', address: 'Kaptai Lake area', landmark: 'Hanging Bridge' },
      basePrice: '11000',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 12,
      maxGuests: 12,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828', storageKey: 'tour-10', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'UNESCO World Heritage Site visit. 15th-century mosque city built by Khan Jahan Ali.',
      location: { city: 'Bagerhat', district: 'Khulna', address: 'Bagerhat Sadar', landmark: 'Sixty Dome Mosque' },
      basePrice: '2000',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 40,
      maxGuests: 40,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1564769625905-50e93615e769', storageKey: 'tour-11', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Day trip to see cascading waterfalls, stone collection sites, and the border river with India.',
      location: { city: 'Sylhet', district: 'Sylhet', address: 'Jaflong Zero Point', landmark: 'Dawki River' },
      basePrice: '4000',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 20,
      maxGuests: 20,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1433086966358-54859d0ed716', storageKey: 'tour-12', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Experience the "bowl of water" during monsoon. Boat through endless wetlands, visit floating villages.',
      location: { city: 'Sunamganj', district: 'Sylhet', address: 'Tanguar Haor', landmark: 'Wetland Sanctuary' },
      basePrice: '7500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 18,
      maxGuests: 18,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19', storageKey: 'tour-13', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Historical tour following Bangladesh\'s 1971 Independence War. Visit Mujibnagar Memorial, war museums.',
      location: { city: 'Meherpur', district: 'Khulna', address: 'Mujibnagar', landmark: 'Independence Memorial' },
      basePrice: '5500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 25,
      maxGuests: 25,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa', storageKey: 'tour-14', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Vintage paddlewheel steamer journey on the Padma River. Colonial-era luxury travel experience.',
      location: { city: 'Dhaka', district: 'Dhaka', address: 'Sadarghat River Port', landmark: 'Rocket Steamer Terminal' },
      basePrice: '4500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 50,
      maxGuests: 50,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5', storageKey: 'tour-15', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
  ...
  const tourSellers = sellers.filter(s => s.category === 'tour-operator' || s.category === 'agency');
  let sellerIndex = 0;
...
async function createExperiences(sellers: any[]) {
  ...
  const experiences = [
    {
      ...
      description: 'Learn ancient pottery techniques from master artisans. Create your own terracotta piece to take home.',
      location: { city: 'Dhaka', district: 'Dhaka', address: 'Dhamrai', landmark: 'Pottery Village' },
      basePrice: '1200',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 12,
      maxGuests: 12,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261', storageKey: 'exp-1', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Dawn fishing expedition on the Padma River. Traditional net fishing techniques, fresh catch breakfast.',
      location: { city: 'Manikganj', district: 'Dhaka', address: 'Padma River Bank', landmark: 'Fishing Village' },
      basePrice: '2500',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 8,
      maxGuests: 8,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19', storageKey: 'exp-2', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Master authentic Bengali dishes in a local home. Market tour, hands-on cooking, family-style dining.',
      location: { city: 'Dhaka', district: 'Dhaka', address: 'Dhanmondi', landmark: 'Local Residence' },
      basePrice: '1800',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 8,
      maxGuests: 8,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d', storageKey: 'exp-3', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Discover Bangladesh\'s vibrant rickshaw art tradition. Paint your own miniature rickshaw panel.',
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f', storageKey: 'exp-4', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Peaceful evening cruise on Bangladesh\'s largest lake. Watch tribal villages light up as sun sets.',
      location: { city: 'Rangamati', district: 'Chittagong', address: 'Kaptai Lake', landmark: 'Hanging Bridge' },
      basePrice: '800',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 20,
      maxGuests: 20,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4', storageKey: 'exp-5', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Learn handloom weaving from skilled artisans. Create your own woven scarf or napkin.',
      location: { city: 'Tangail', district: 'Dhaka', address: 'Weaver Village', landmark: 'Handloom Center' },
      basePrice: '1600',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 6,
      maxGuests: 6,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1610992015762-45b2d7c60c0d', storageKey: 'exp-6', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Capture the essence of Old Dhaka with a professional photographer. Learn composition and storytelling.',
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1452587925148-ce544e77e70d', storageKey: 'exp-7', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Morning yoga session on Cox\'s Bazar beach. Meditation, pranayama, and seaside relaxation.',
      location: { city: "Cox's Bazar", district: "Cox's Bazar", address: 'Sugandha Beach', landmark: 'Meditation Point' },
      basePrice: '1000',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 15,
      maxGuests: 15,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773', storageKey: 'exp-8', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Visit a working tea estate. Walk through tea plantations, observe processing, taste 7 varieties.',
      location: { city: 'Sylhet', district: 'Sylhet', address: 'Srimongal', landmark: 'Finlay Tea Estate' },
      basePrice: '2200',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 12,
      maxGuests: 12,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1563729784474-d77dbb933a9e', storageKey: 'exp-9', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Tandem paragliding over the world\'s longest beach. Professional pilot, safety equipment included.',
      location: { city: "Cox's Bazar", district: "Cox's Bazar", address: 'Kolatoli Beach', landmark: 'Adventure Sports Center' },
      basePrice: '6000',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 8,
      maxGuests: 8,
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1529672337062-e3915a3b8f05', storageKey: 'exp-10', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
  ...
  const experienceSellers = sellers.filter(s => s.category === 'tour-operator' || s.category === 'agency');
  let sellerIndex = 0;
  ...
  const transports = [
    {
      ...
      description: 'Comfortable airport pickup/drop-off service. Professional driver, AC vehicle, meet and greet service.',
      location: { city: 'Dhaka', district: 'Dhaka', address: 'Hazrat Shahjalal International Airport', landmark: 'Airport Terminal' },
      basePrice: '1500',
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2', storageKey: 'transport-1', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Overnight AC sleeper coach. Comfortable seats, onboard entertainment, refreshments included.',
      location: { city: "Cox's Bazar", district: "Cox's Bazar", address: 'Bus Terminal', landmark: 'Central Bus Stand' },
      basePrice: '1200',
      priceUnit: PRICE_UNITS.PER_PERSON,
      capacity: 40,
      maxGuests: 40,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957', storageKey: 'transport-2', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: '8-hour car rental with driver. Visit multiple destinations in Dhaka at your own pace.',
      ...
      groupEligible: false,
      images: [
        { url: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d', storageKey: 'transport-3', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: '12-seater AC microbus for Sylhet tours. Visit Jaflong, Ratargul, tea gardens comfortably.',
      location: { city: 'Sylhet', district: 'Sylhet', address: 'Sylhet Sadar', landmark: 'City Center' },
      basePrice: '8000',
      priceUnit: PRICE_UNITS.PER_BOOKING,
      capacity: 12,
      maxGuests: 12,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957', storageKey: 'transport-4', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
    {
      ...
      description: 'Private boat for Sundarbans safari. Experienced crew, safety equipment, comfortable seating.',
      location: { city: 'Khulna', district: 'Khulna', address: 'Mongla Port', landmark: 'Sundarbans Entry' },
      basePrice: '25000',
      priceUnit: PRICE_UNITS.PER_BOOKING,
      capacity: 20,
      maxGuests: 20,
      ...
      images: [
        { url: 'https://images.unsplash.com/photo-1606122017369-d782bbb78f32', storageKey: 'transport-5', isPrimary: true },
      ],
      status: LISTING_STATUSES.ACTIVE,
      publishedAt: new Date(),
    },
