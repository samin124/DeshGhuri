...
const newListing = await db
  ...
  .values({
    ...
    description:
      "Experience the world's longest natural sea beach with our exclusive package. Includes accommodation in a 4-star beach resort, daily breakfast, guided beach tours, and visit to Himchari National Park. Perfect for families and couples looking for a relaxing beach getaway.",
