...
export function generateTicketPDF(data: TicketData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .fillColor('#e0e7ff')
      .font('Helvetica')
      .text('Travel Booking Confirmation', leftMargin, 50, {
        width: contentWidth,
        align: 'center',
      });
    ...
    if (data.checkInDate && data.checkOutDate) {
      doc.fontSize(9).fillColor('#6b7280').font('Helvetica').text('CHECK-IN', rightCol, currentY);
    ...
    // Guest Information
    currentY += 95;
    doc.fontSize(9).fillColor('#6b7280').font('Helvetica').text('GUESTS', leftMargin, currentY);
    ...
    doc
      ...
      .font('Helvetica-Bold')
      .text(
        `${data.totalGuests} Guest${data.totalGuests > 1 ? 's' : ''}`,
        leftMargin,
        currentY + 15
      );
    ...
    doc
      ...
      .fillColor('#6b7280')
      .font('Helvetica')
      .text(`Confirmed on ${formatDate(data.approvedAt)}`, leftMargin, currentY, {
        width: contentWidth,
        align: 'center',
      });
    ...
    currentY += 30;
    doc
      .rect(leftMargin, currentY, contentWidth, 60)
    ...
    doc
      ...
      .font('Helvetica')
      .text(
        'Please present this ticket at the venue for verification.',
        leftMargin + 15,
        currentY + 30,
    ...
    doc
      ...
      .fillColor('#9ca3af')
      .font('Helvetica')
      .text('© 2026 DeshGhuri | support@deshghuri.com', leftMargin, currentY, {
        width: contentWidth,
        align: 'center',
      });
...
export function generateReceiptPDF(data: ReceiptData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .fillColor('#d1fae5')
      .font('Helvetica')
      .text('Official Payment Confirmation', leftMargin, 50, {
        width: contentWidth,
        align: 'center',
      });
    ...
    doc
      ...
      .fillColor('#6b7280')
      .font('Helvetica')
      .text(`Date: ${formatDate(data.paidAt)}`, rightMargin - 120, currentY + 22, {
        width: 120,
        align: 'right',
      });
    ...
    currentY = 325;
    doc
      .rect(leftMargin, currentY, contentWidth, 160)
    ...
    // Breakdown Items
    doc.fontSize(10).fillColor('#6b7280').font('Helvetica').text('Base Amount', labelX, currentY);
    ...
    doc
      ...
      .font('Helvetica')
      .text(
        `৳ ${parseFloat(data.baseAmount).toLocaleString('en-BD', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
        valueX - 100,
        currentY,
    ...
    currentY += 25;
    doc.fontSize(10).fillColor('#6b7280').font('Helvetica').text('Tax (5%)', labelX, currentY);
    ...
    doc
      ...
      .font('Helvetica')
      .text(
        `৳ ${parseFloat(data.tax).toLocaleString('en-BD', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
        valueX - 100,
        currentY,
        { width: 100, align: 'right' }
      );
    ...
    doc
      ...
      .font('Helvetica')
      .text(
        `৳ ${parseFloat(data.platformFee).toLocaleString('en-BD', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
        valueX - 100,
        currentY,
        { width: 100, align: 'right' }
      );
    ...
    if (data.discount && parseFloat(data.discount) > 0) {
      currentY += 25;
      doc.fontSize(10).fillColor('#059669').font('Helvetica').text('Discount', labelX, currentY);
      ...
      doc
        ...
        .font('Helvetica')
        .text(
          `- ৳ ${parseFloat(data.discount).toLocaleString('en-BD', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
          valueX - 100,
          currentY,
          { width: 100, align: 'right' }
        );
    ...
    doc
      ...
      .font('Helvetica-Bold')
      .text(
        `৳ ${parseFloat(data.totalAmount).toLocaleString('en-BD', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
        valueX - 150,
        currentY - 3,
    ...
    currentY = 620;
    doc
      .rect(leftMargin + (contentWidth - 180) / 2, currentY, 180, 60)
    ...
    doc
      ...
      .fillColor('#059669')
      .font('Helvetica-Bold')
      .text('✓ PAYMENT VERIFIED', leftMargin, currentY + 15, {
        width: contentWidth,
        align: 'center',
      });
    ...
    doc
      ...
      .fillColor('#047857')
      .font('Helvetica')
      .text('DeshGhuri Marketplace', leftMargin, currentY + 38, {
        width: contentWidth,
        align: 'center',
      });
    ...
    doc
      ...
      .fillColor('#9ca3af')
      .font('Helvetica')
      .text('This is a computer-generated receipt. No signature required.', leftMargin, currentY, {
        width: contentWidth,
        align: 'center',
      });
    ...
    doc
      .fontSize(8)
      .fillColor('#9ca3af')
      .text('For queries: support@deshghuri.com', leftMargin, currentY + 15, {
        width: contentWidth,
        align: 'center',
      });
