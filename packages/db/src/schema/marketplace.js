...
export const listing = pgTable(
  'listing',
  {
    ...
    // Location
    location: json('location').$type().notNull(),
    // Pricing
    ...
    inclusions: json('inclusions').$type().default([]),
    exclusions: json('exclusions').$type().default([]),
    // Policies
...
export const booking = pgTable(
  'booking',
  {
    ...
    // Guest Details
    guestDetails: json('guest_details').$type().notNull(),
    // Dates
...
export const payout = pgTable(
  'payout',
  {
    ...
    bankDetails: json('bank_details').$type().notNull(),
    // Included Escrow Transactions
    escrowTransactionIds: json('escrow_transaction_ids').$type().notNull(),
    // Status
