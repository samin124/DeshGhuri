...
export declare const userRelations: import('drizzle-orm').Relations<
  'user',
  {
    ...
    roles: import('drizzle-orm').Many<'user_role'>;
    createdRoles: import('drizzle-orm').Many<'user_role'>;
  }
>;
...
export declare const userRoleRelations: import('drizzle-orm').Relations<
  'user_role',
  {
    user: import('drizzle-orm').One<'user', true>;
